                      ...
                      (<li><b>Subtopics:</b>
                        <ul>
                          {props.subTopics.map((e) => (
                            <li key={e.id}><a href={ENDPOINT+e.id}>{e.attributes.title}</a></li>
                          ))}
                        </ul>
                      </li>)
